...
type Service interface {
	...
	PurchaseOrders(params PurchaseOrdersQueryParam) (purchaseOrders []PurchaseOrder, isLastPage bool, err error) // 采购单列表
	CreatePurchaseOrder(params CreatePurchaseOrderRequest) (number string, err error)                            // 创建采购单
	SaleAccounts(params SaleAccountQueryParams) (accounts []SaleAccount, isLastPage bool, err error)             // 创建采购单
}
